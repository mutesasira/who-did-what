...
export const eventCounts = (
  ...
  return {
    ...
    id: "kCt1rIMGkJb",
    sqlQuery: `select storedby,status,COUNT(programstageinstanceid) from programstageinstance where storedby in (${logins}) ${dateQuery} and deleted = false group by storedby,status;`,
